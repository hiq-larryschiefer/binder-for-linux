...
/* Fix for GNU C/C++ atomic extensions.
   This is needed as the _Atomic keyword and __auto_type are only defined
   for buildign C11, not when building C++11.  Similarly, _Bool is not a
   keyword, but defined in stdbool.h, so include that before stdatomic.h.
*/
#if (__GNUC__ && __cplusplus)
#define _Atomic __attribute__((atomic))
#include <stdbool.h>
